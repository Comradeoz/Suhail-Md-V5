const { smd } = require('../TalkDrove/Hamza');
...
smd({ nomCom: "bot", reaction: "👻", categorie: "AI" }, async (dest, zk, commandeOptions) => {
...
smd({ nomCom: "dalle", reaction: "🤡", categorie: "AI" }, async (dest, zk, commandeOptions) => {
...
smd({ nomCom: "gpt", reaction: "🎃", categorie: "AI" }, async (dest, zk, commandeOptions) => {
  const { repondre, arg, ms } = commandeOptions;
